...
{message}
                ...
                <div>
                    ...
                    <input type="text" className='border w-full rounded-lg px-2 h-9 mt-3' placeholder='Enter Email here' onChange={(e)=>{setUser({...user , email : e.target.value})}} />
                </div>
                <div>
                    <label htmlFor="">Full Name</label>
                    <input type="text" className='border w-full rounded-lg px-2 h-9 mt-3' placeholder='Enter Fullname here' onChange={(e)=>{setUser({...user , fullName : e.target.value})}} />
                </div>
                <div>
                    <label htmlFor="">Password</label>
                    <input type="password" className='border w-full rounded-lg px-2 h-9 mt-3' placeholder='Enter Password here' onChange={(e)=>{setUser({...user , password : e.target.value})}} />
                </div>
                <div>
                    <label htmlFor="">Role</label>
                    <select name="role" id="" className='border w-full rounded-lg px-2 h-9 mt-3' onChange={(e)=>{setUser({...user , role : e.target.value})}}>
