      ...
      <div className="flex w-full justify-center py-10">
        ...
        <div className="max-w-[900px] w-[90%] flex flex-col items-center gap-4">
          ...
          <Table
            ...
            body={drinkSales?.map((sale) => {
              return {
                ...sale,
                Drink: sale.drinkItem?.name,
                "No Sold": sale.quantity,
                "Unit Price": sale.drinkItem?.price,
                Total: sale.total,
                Date: sale?.createdAt?.split("T")[0],
                "Created By": sale?.addedBy?.userName,
              };
            })}
            actionText={"Edit Sale"}
