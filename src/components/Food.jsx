    ...
    <>
      ...
      <div className="flex w-full justify-center py-10">
        ...
        <div className="max-w-[900px] w-[90%] flex flex-col items-center gap-4">
          ...
          <Table
            header={["Food Item", "Unit Price", "Date", "Added By"]}
            body={foods?.map((food) => {
              return {
                ...food,
                "Food Item": food.name,
                "Unit Price": food.price,
                Date: food?.createdAt?.split("T")[0],
                "Added By": food.addedBy?.fullName,
              };
            })}
            actionText={"Edit Food"}
