            ...
            <div className='relative max-w-[800px] w-[90%] border rounded-lg flex flex-col p-10 gap-4 bg-slate-200' onClick={(e) => e.stopPropagation()}>
                ...
                <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-2'>
                    ...
                    <div className='w-full'>
                        ...
                        <input type="text" className='border w-full rounded-lg px-2 h-9 mt-3' placeholder='Enter Amount here' onChange={(e) => { setRoom({ ...room, total: e.target.value }) }} value={numberWithCommas(room.total)} />
                    </div>
                </div>
                <div>
                    <label htmlFor="">Customer Name</label>
                    <input type="text" className='border w-full rounded-lg px-2 h-9 mt-3' placeholder='Enter Customer Name Here' onChange={(e) => { setRoom({ ...room, customerName: e.target.value }) }} value={room.customerName} />
                </div>
                <div>
                    ...
                    {room.customerId ?
                        <div className="w-64 relative my-5 border border-slate-300 rounded-lg">
                            ...
                            <img
                                src={typeof room.customerId === 'string' ? room.customerId : URL.createObjectURL(room.customerId)}
                                alt=""
